...
Replays, team-overview results, and Statistics now use persisted replay evidence. Their visual analysis experience, uncertainty handling, and diagnostics are documented in [12-replay-implementation.md](12-replay-implementation.md). The remaining matchup and knowledge screens retain the prototype boundary below.
