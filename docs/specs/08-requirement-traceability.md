...
| OI-02 | Reference calculator engine is unnamed.                                              | Small engine wrapper plus conformance corpus.                                                                                    | Engineering/product/legal, before phase 5             |
...
| OI-10 | Manual entry/incomplete team persistence boundary is unclear between P0 and FR-2.12. | Manual P0 sets must meet launch rules; parser may hold incomplete drafts/errors; persistent exploratory incomplete slots are P1. | Product, before phase 1                               |
